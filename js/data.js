...
const Data = (function () {
  ...
  function init() {
    ...
    const LATEST_VIDEO_CONFIG = {
      ...
      bullying:  { url: 'https://youtu.be/s2jhJCXkCTk', title: '職場霸凌預防舉措教材' },
      osh:       { url: 'https://youtu.be/MjhhoNG-nBk', title: '職業安全衛生教材' },
      ai_policy: { url: 'https://youtu.be/DJkC9ct782Q', title: 'AI人工智慧使用方法教材' }
    };
